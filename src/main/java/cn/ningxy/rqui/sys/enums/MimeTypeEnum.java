...
/**
 * @author <a href:"https://blog.csdn.net/qq_42910468/article/details/109445063">CSDN博客</a>
 * @author ningxy
 */
@Getter
public enum MimeTypeEnum {
     ...
     * 后缀名 MIME 类型枚举
     */
    QuickTime("mov", "mov视频", "video/quicktime"),

    WindowsMedia("wmv", "win视频", "video/x-ms-wmv"),

    MPEG_4("mp4", "mp4视频", "video/mp4"),
     ...
     * 构造 MimeType 的 List
     *
     * @param type MimeTypeEnum
     * @return List<String>
     */
    public static List<String> getTypeList(MimeTypeEnum... type) {
        return Arrays.stream(type)
                .map(MimeTypeEnum::getMimeType)
